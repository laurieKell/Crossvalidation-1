...
To explore the robustness of advice to uncertainty requires different model structures to be condition on alternative and potentially conflicting datasets. %In such cases, however, model selection criteria such as AIC, cannot be applied. 
